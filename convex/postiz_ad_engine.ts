...
export const generateAdCopy = action({
  ...
  handler: async (ctx, args) => {
    const AGENTS: Record<string, { name: string; description: string; capabilities: string[] }> = {
      A1: { name: "Academic Pro", description: "Thesis, Research Papers, Dissertation", capabilities: ["writing", "research"] },
      A2: { name: "Business Pro", description: "Business Plan, Financial Model, Pitch Deck", capabilities: ["planning", "finance"] },
      A3: { name: "Content Pro", description: "Blog Posts, Social Media, Copywriting", capabilities: ["writing", "marketing"] },
      A4: { name: "Career Pro", description: "Resume, Cover Letter, Interview Prep", capabilities: ["writing", "coaching"] },
      A5: { name: "Personal Shopper", description: "Product Research, Price Comparison", capabilities: ["research", "comparison"] },
      A6: { name: "Exam Pro", description: "Exam Prep, Practice Tests", capabilities: ["teaching", "assessment"] },
      A7: { name: "Finance Pro", description: "Investment Analysis, Budgeting", capabilities: ["analysis", "planning"] },
      A8: { name: "MediaStudio Pro", description: "Video Production, Editing", capabilities: ["video", "editing"] },
      A9: { name: "Wellness Pro", description: "Health Plans, Nutrition", capabilities: ["planning", "coaching"] },
      A10: { name: "Home Services", description: "Cleaning, Maintenance", capabilities: ["scheduling", "support"] },
      A11: { name: "Language Tutor", description: "Language Learning", capabilities: ["teaching", "practice"] },
      A12: { name: "Travel Planner", description: "Trip Planning, Booking", capabilities: ["planning", "booking"] },
      A13: { name: "ServiceMart NG", description: "General Services", capabilities: ["matching", "coordination"] },
      A14: { name: "Translation Hub", description: "Translation, Localization", capabilities: ["translation", "review"] },
      A15: { name: "Event Planner", description: "Event Planning", capabilities: ["planning", "management"] },
    };
