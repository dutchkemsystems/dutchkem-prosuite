...
const HYPERSCALE_TYPES: Array<{ id: string; name: string; employees: string; countries: string; price: number; agents: number; icon: string; color: string; border: string; features: string[]; description: string; subdomain: string }> = [
  { id: 'H1', name: 'Global Banking & Finance', employees: '500,000+', countries: '50+', price: 49999, agents: 25, icon: '🏦', color: 'from-blue-500/20 to-blue-600/10', border: 'border-blue-500/30', features: ['Fraud Detection', 'KYC Automation', 'Risk Management', 'Compliance Monitoring', 'Trading Algorithms'], description: 'Banking and financial services', subdomain: 'banking' },
  { id: 'H2', name: 'International Manufacturing', employees: '1,000,000+', countries: '40+', price: 59999, agents: 30, icon: '🏭', color: 'from-orange-500/20 to-orange-600/10', border: 'border-orange-500/30', features: ['Supply Chain Optimization', 'Predictive Maintenance', 'Quality Control', 'Inventory Management'], description: 'Manufacturing operations', subdomain: 'manufacturing' },
  { id: 'H3', name: 'Worldwide E-commerce', employees: '800,000+', countries: '60+', price: 69999, agents: 35, icon: '🛒', color: 'from-emerald-500/20 to-emerald-600/10', border: 'border-emerald-500/30', features: ['Personalization Engine', 'Fraud Detection', 'Logistics Optimization', 'Customer Service AI'], description: 'E-commerce platforms', subdomain: 'ecommerce' },
  { id: 'H4', name: 'Global Healthcare Network', employees: '600,000+', countries: '30+', price: 79999, agents: 28, icon: '🏥', color: 'from-rose-500/20 to-rose-600/10', border: 'border-rose-500/30', features: ['Patient Records', 'Telemedicine', 'Insurance Processing', 'Compliance (HIPAA)'], description: 'Healthcare services', subdomain: 'healthcare' },
  { id: 'H5', name: 'Multi-National Telecom', employees: '700,000+', countries: '45+', price: 89999, agents: 32, icon: '📡', color: 'from-cyan-500/20 to-cyan-600/10', border: 'border-cyan-500/30', features: ['Network Optimization', 'Customer Churn Prediction', 'Billing Automation', 'Infrastructure Monitoring'], description: 'Telecommunications', subdomain: 'telecom' },
  { id: 'H6', name: 'Global Logistics & Shipping', employees: '500,000+', countries: '80+', price: 99999, agents: 40, icon: '🚚', color: 'from-amber-500/20 to-amber-600/10', border: 'border-amber-500/30', features: ['Route Optimization', 'Fleet Management', 'Warehouse Automation', 'Real-time Tracking'], description: 'Logistics operations', subdomain: 'logistics' },
  { id: 'H7', name: 'International Energy Corp', employees: '400,000+', countries: '35+', price: 119999, agents: 38, icon: '⚡', color: 'from-yellow-500/20 to-yellow-600/10', border: 'border-yellow-500/30', features: ['Grid Management', 'Predictive Analytics', 'Safety Monitoring', 'Compliance Reporting'], description: 'Energy sector', subdomain: 'energy' },
  { id: 'H8', name: 'Worldwide Retail Chain', employees: '900,000+', countries: '55+', price: 129999, agents: 45, icon: '🛍️', color: 'from-pink-500/20 to-pink-600/10', border: 'border-pink-500/30', features: ['Inventory Optimization', 'Price Optimization', 'Customer Insights', 'Store Operations'], description: 'Retail operations', subdomain: 'retail' },
  { id: 'H9', name: 'Global Tech Conglomerate', employees: '1,500,000+', countries: '70+', price: 149999, agents: 50, icon: '🖥️', color: 'from-violet-500/20 to-violet-600/10', border: 'border-violet-500/30', features: ['DevOps Automation', 'Security Monitoring', 'Employee Collaboration', 'Product Development'], description: 'Technology companies', subdomain: 'tech' },
  { id: 'H10', name: 'Mega Government Agency', employees: '2,000,000+', countries: '100+', price: 199999, agents: 60, icon: '🏛️', color: 'from-indigo-500/20 to-indigo-600/10', border: 'border-indigo-500/30', features: ['Citizen Services', 'Document Processing', 'Compliance Enforcement', 'Data Analytics'], description: 'Government services', subdomain: 'government' },
]
