...
import { BrandSection, ScheduleSection, BulkSection, CarouselSection, WorkflowsSection, AnalyticsSection, Modal } from "./TryPostSubComponents";
...
export function TryPostScheduler({ adminToken }: AdminPanelProps) {
  ...
  // Sub-components moved to TryPostSubComponents.tsx